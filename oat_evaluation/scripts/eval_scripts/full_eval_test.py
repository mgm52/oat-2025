                ...
                wandb.init(
                     ...
                     config={
                         ...
                         "attack_params": {
                             ...
                             "attack_llm": attack.attack_llm if isinstance(attack, PAIRAttack) else None,
                             "judge_llm": attack.judge_llm if isinstance(attack, PAIRAttack) else None,
                             # GCG parameters

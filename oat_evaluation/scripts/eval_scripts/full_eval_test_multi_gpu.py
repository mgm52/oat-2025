...
if __name__ == "__main__":
    ...
    wandb_group_name = f"{datetime.now().strftime('%Y%m%d_%H%M%S')}_{os.getpid()}_gcg_128"
    commands = [
          # 0.1x test samples
     ...
     # Regular evals
        ...
        #  ["python", "oat_evaluation/scripts/eval_scripts/full_eval_test.py", "--probe_names", "llama_3_8b_cb_linear_highlr", "--group-name", wandb_group_name, "--num_harmful_test_samples", "256"],
         ...
         ["python", "oat_evaluation/scripts/eval_scripts/full_eval_test.py", "--probe_names", "llama_3_8b_linear", "--group-name", wandb_group_name, "--num_harmful_test_samples", "256", "--num_samples_when_slow", "20"],
         ...
         ["python", "oat_evaluation/scripts/eval_scripts/full_eval_test.py", "--probe_names", "llama_3_8b_cb_linear_midlr", "--group-name", wandb_group_name, "--num_harmful_test_samples", "256", "--num_samples_when_slow", "20"],
         ["python", "oat_evaluation/scripts/eval_scripts/full_eval_test.py", "--probe_names", "llama_3_8b_refat", "--group-name", wandb_group_name, "--num_harmful_test_samples", "256", "--num_samples_when_slow", "20"],
         #["python", "oat_evaluation/scripts/eval_scripts/full_eval_test.py", "--probe_names", "llama_3_8b_linear", "--group-name", wandb_group_name, "--num_harmful_test_samples", "256", "--num_samples_when_slow", "20"],
         #["python", "oat_evaluation/scripts/eval_scripts/full_eval_test.py", "--probe_names", "llama_3_8b_oat_linear_highpgd", "--group-name", wandb_group_name, "--num_harmful_test_samples", "256", "--num_samples_when_slow", "20"],
         #["python", "oat_evaluation/scripts/eval_scripts/full_eval_test.py", "--probe_names", "llama_3_8b_cb_linear_midlr", "--group-name", wandb_group_name, "--num_harmful_test_samples", "256", "--num_samples_when_slow", "20"],
    ...
    run_many_commands_on_gpus(commands, USE_ALL_GPUS=True, log_dir="oat_evaluation/outputs/eval_logs", max_prior_mem_usage_mb=20000, max_concurrent_jobs_per_gpu=1)